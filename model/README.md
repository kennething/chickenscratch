...
2. See the [training README](https://github.com/ThisRyanZhou/creating-the-model?tab=readme-ov-file#training)
   for instructions on how to train the model.

   It may take a few hours to train, depending on your machine.
